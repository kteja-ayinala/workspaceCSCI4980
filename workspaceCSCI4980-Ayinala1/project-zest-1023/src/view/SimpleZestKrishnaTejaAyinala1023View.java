...
public class SimpleZestKrishnaTejaAyinala1023View {
	private Graph graph;
	...
	private String filePath = "/Users/krishnatejaayinala/workspaceCSCI4980/workspaceCSCI4980-Ayinala1/project-zest-1023/src/input-data-zest-1023.txt";

	public SimpleZestKrishnaTejaAyinala1023View() {
	}
	...
	public void createControls(Composite parent) {
		graph = new Graph(parent, SWT.NONE); // Graph will hold all other
												// objects
		createGraphNode();
...
//		 SWT.NONE, node1, node4);
		...
		new GraphConnection(graph,
					 SWT.NONE, this.mapGraphNode.get(iConn[0]), this.mapGraphNode.get(iConn[1]));
//			new GraphConnection(graph, SWT.NONE, this.mapGraphNode.get(iConn[0]), this.mapGraphNode.get(iConn[1]));
	...
	void findUpdateSimpleView(Item iNode) {
		// MPart findPart =
		// service.findPart(SimpleZestKrishnaTejaAyinala1023View.ID);
		// SimpleZestKrishnaTejaAyinala1023View simpleView =
		// (SimpleZestKrishnaTejaAyinala1023View) findPart.getObject();
