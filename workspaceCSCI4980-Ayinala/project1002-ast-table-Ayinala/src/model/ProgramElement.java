...
public class ProgramElement {
	...
	private Integer methodStartPos;

	// public ProgramElement(String pkgName2, String className2, String
	// methodName2, boolean isRetVoid, int parmSize, int methodStartLine) {
	// }
	...
	public ProgramElement(String pkgName, String className, String methodName, boolean isRetVoid, int parmSize,
		...
		this.methodStartPos = methodStartLine;
	}
